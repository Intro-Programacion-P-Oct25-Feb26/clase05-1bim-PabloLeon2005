        ...
        if ((promedio >= 7.5) && (promedio <= 10)) {
            ...
            if ((promedio >= 5) && (promedio < 7.5)) {
                ...
                if ((promedio >= 3) && (promedio < 5)) {
                    mensaje = String.format("Estudiante en recuperación con un "
                            + "promedio: %.2f\n", promedio);
                } else {
                    if ((promedio >= 3) && (promedio < 3)) {
                        ...
                        if ((promedio >= 0) && (promedio < 3)) {
                            mensaje = String.format("Estudiante ha reprobado con un "
                                    + "promedio: %.2f\n", promedio);

                        } else {
                            if (promedio > 10) {
                                mensaje = String.format("La nota %.2f está fuera de rango "
                                        + "por qué está ingresando un valor mayor "
                                        + "a 10",
                                        promedio);
                            } else {
                                if (promedio < 0) {
                                    mensaje = String.format("La nota %.2f está fuera "
                                            + "de rango"
                                            + " por que está ingresando un "
                                            + "valor negativo",
                                            promedio);
